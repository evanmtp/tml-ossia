...
,
		"classnamespace" : "box",
		"openrect" : [ 90.0, 90.0, 270.0, 105.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "ossia.gl_repos.view.maxpat",
					"numinlets" : 1,
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 0.0, 0.0, 195.0, 105.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 180.0, 117.0, 20.0 ],
					"text" : "ossia.gl_repos.model #1"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "ossia.gl_repos.model.maxpat",
				"bootpath" : "~/Github/tml-ossia/video/spatial/ossia.gl_repos",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
