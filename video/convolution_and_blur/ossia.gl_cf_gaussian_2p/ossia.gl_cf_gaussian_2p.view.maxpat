...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 150.0, 165.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 105.0, 45.0, 45.0, 21.0 ],
					"triangle" : 0,
					"varname" : "TOL[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 195.0, 345.0, 115.0, 21.0 ],
					"text" : "ossia.remote width/y",
					"varname" : "tolerance[1]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 45.0, 315.0, 50.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 45.0, 345.0, 115.0, 21.0 ],
					"text" : "ossia.remote width/x",
					"varname" : "tolerance[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 270.0, 63.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -1.0, 45.0, 50.0, 19.0 ],
					"text" : "width"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 326.0, 262.0, 142.0, 21.0 ],
					"text" : "ossia.view #1",
					"varname" : "jmod.hub"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 326.0, 289.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 326.0, 229.0, 25.0, 25.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 204.5, 369.0, 180.0, 369.0, 180.0, 309.0, 204.5, 309.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-34::obj-3::obj-2" : [ "live.text[1]", "live.text", 0 ],
			"parameterbanks" : 			{
