...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 300.0, 135.0, 165.0, 75.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 270.0, 263.0, 22.0 ],
									"text" : "ossia.gl_cf_gaussian_2p.model cf_gaussian_2p"
								}
...
, 			{
				...
				"bootpath" : "~/Desktop/stable/convolution_and_blur/ossia.gl_cf_gaussian_2p",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
