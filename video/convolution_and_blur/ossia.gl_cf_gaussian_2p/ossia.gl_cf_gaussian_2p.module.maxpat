...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "ossia.gl_cf_gaussian_2p.view.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 0.0, 0.0, 165.0, 75.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 135.0, 193.0, 22.0 ],
					"text" : "ossia.gl_cf_gaussian_2p.model #1",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 180.0, 27.0, 27.0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-1::obj-2" : [ "live.text[1]", "live.text", 0 ],
			"parameterbanks" : 			{
...
,
		"dependency_cache" : [ 			{
				"name" : "ossia.gl_cf_gaussian_2p.model.maxpat",
				"bootpath" : "~/Github/tml-ossia/video/convolution_and_blur/ossia.gl_cf_gaussian_2p",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
