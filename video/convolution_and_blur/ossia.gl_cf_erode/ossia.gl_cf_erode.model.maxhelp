...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "bang", "" ],
									"patching_rect" : [ 15.0, 105.0, 174.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"lockeddragscroll" : 1,
									"maxclass" : "bpatcher",
									"name" : "ossia.gl_cf_erode.view.maxpat",
									"numinlets" : 1,
									"numoutlets" : 1,
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 210.0, 75.0, 135.0, 75.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 210.0, 189.0, 22.0 ],
									"text" : "ossia.gl_cf_erode.model cf_erode",
									"varname" : "gl_cf_dilate.model"
								}
...
,
		"dependency_cache" : [ 			{
				"name" : "ossia.gl_cf_erode.model.maxpat",
				"bootpath" : "~/Downloads/stable/convolution_and_blur/ossia.gl_cf_erode",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
