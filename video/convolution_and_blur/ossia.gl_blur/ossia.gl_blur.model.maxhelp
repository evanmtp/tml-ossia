...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"text" : "GL blur based on blur module from Vsynth by Kevin Kripper."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "bang", "" ],
									"patching_rect" : [ 15.0, 105.0, 183.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"lockeddragscroll" : 1,
									"maxclass" : "bpatcher",
									"name" : "ossia.gl_blur.view.maxpat",
									"numinlets" : 1,
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 225.0, 75.0, 135.0, 75.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 15.0, 210.0, 157.0, 22.0 ],
									"text" : "ossia.gl_blur.model pix_blur"
								}
...
,
		...
		"parameters" : 		{
			...
			"obj-34::obj-3::obj-1" : [ "live.text[1]", "live.text", 0 ],
			"parameterbanks" : 			{
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Github/phase/ossia/gl_blur",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
