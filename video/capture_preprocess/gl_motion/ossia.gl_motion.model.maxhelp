...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 270.0, 510.0, 80.0, 35.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 45.0, 240.0, 33.0 ],
									"text" : "GL-based recreation of j.motion%. Currently does not draw bounding box."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 405.0, 89.0, 22.0 ],
									"text" : "read bball.mov"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 150.0, 630.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 255.0, 630.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 315.0, 630.0, 63.0, 22.0 ],
									"text" : "unpack f f"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "ossia.remote glmotion/mean"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 210.0, 630.0, 15.0, 75.0 ],
									"size" : 1.0
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 210.0, 570.0, 90.0, 35.0 ],
									"text" : "ossia.remote glmotion/mass"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 120.0, 630.0, 15.0, 75.0 ],
									"size" : 1.0
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 120.0, 570.0, 90.0, 35.0 ],
									"text" : "ossia.remote glmotion/y"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 15.0, 570.0, 87.0, 35.0 ],
									"text" : "ossia.remote glmotion/x"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 15.0, 435.0, 259.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "bang", "" ],
									"patching_rect" : [ 15.0, 120.0, 212.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 225.0, 300.0, 135.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 24.5, 498.0, 279.5, 498.0 ],
									"order" : 0,
									"source" : [ "obj-13", 0 ]
								}
