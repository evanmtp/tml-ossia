...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"text" : "jit.gl.pix-based temporal interpolation."
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 225.0, 75.0, 210.0, 120.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"text" : "ossia.gl_pix_slide.model pix_slide"
								}
...
,
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-34::obj-3::obj-8" : [ "live.tab", "live.tab", 0 ],
