...
,
		"classnamespace" : "box",
		"openrect" : [ 90.0, 90.0, 270.0, 210.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "ossia.gl_bfg.view.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 0.0, 0.0, 270.0, 150.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 270.0, 125.0, 22.0 ],
					"text" : "ossia.gl_bfg.model #1"
				}
