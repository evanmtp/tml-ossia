...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 315.0, 270.0, 62.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 45.0, 45.0, 30.0, 22.0 ],
					"varname" : "TOL[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 315.0, 300.0, 105.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 45.0, 94.0, 21.0 ],
					"text" : "set #1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 15.0, 180.0, 19.0 ],
					"text" : "gl_composite"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 165.0, 345.0, 50.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 165.0, 375.0, 115.0, 21.0 ],
					"text" : "ossia.remote amount",
					"varname" : "tolerance[3]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 165.0, 270.0, 89.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 45.0, 89.0, 22.0 ],
					"varname" : "TOL[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 165.0, 300.0, 105.0, 21.0 ],
					"text" : "ossia.remote mode",
					"varname" : "tolerance[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 270.0, 63.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 45.0, 63.0, 19.0 ],
					"text" : "mode"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 345.0, 63.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 405.0, 48.0, 130.0, 21.0 ],
					"text" : "ossia.view #1",
					"varname" : "jmod.hub"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 324.5, 324.0, 300.0, 324.0, 300.0, 264.0, 324.5, 264.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 174.5, 324.0, 150.0, 324.0, 150.0, 264.0, 174.5, 264.0 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 174.5, 399.0, 150.0, 399.0, 150.0, 339.0, 174.5, 339.0 ],
					"source" : [ "obj-9", 0 ]
				}
