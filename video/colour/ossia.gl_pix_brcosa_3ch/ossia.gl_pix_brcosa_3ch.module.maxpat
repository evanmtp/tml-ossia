...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "ossia.gl_pix_brcosa_3ch.view.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 238.0, 193.0, 22.0 ],
					"text" : "ossia.gl_pix_brcosa_3ch.model #1",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 283.0, 27.0, 27.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 282.0, 26.0, 26.0 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "ossia.gl_pix_brcosa_3ch.model.maxpat",
				"bootpath" : "~/Github/tml-ossia/video/colour/ossia.gl_pix_ brcosa_3ch",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
