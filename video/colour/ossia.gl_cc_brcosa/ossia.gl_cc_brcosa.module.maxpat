...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 0.0, 0.0, 135.0, 120.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 180.0, 240.0, 22.0 ],
					"style" : "",
					"text" : "ossia.gl_cc_brcosa.model #1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 137.0, 26.0, 26.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 232.0, 224.0, 27.0, 27.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 224.0, 26.0, 26.0 ],
					"style" : ""
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 245.5, 212.5, 241.5, 212.5 ],
					"source" : [ "obj-28", 1 ]
				}
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Downloads/stable/colour/gl_cc_brcosa",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
