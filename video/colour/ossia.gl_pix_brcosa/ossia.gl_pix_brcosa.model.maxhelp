...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "jit.gl.pix-based brightness/contrast/saturation effect."
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 15.0, 270.0, 133.0, 22.0 ],
									"style" : "",
...
,
									...
									"patching_rect" : [ 15.0, 195.0, 150.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"lockeddragscroll" : 1,
									"maxclass" : "bpatcher",
									"name" : "ossia.gl_pix_brcosa.view.maxpat",
									"numinlets" : 1,
									"numoutlets" : 1,
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 180.0, 75.0, 135.0, 120.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 15.0, 240.0, 213.0, 22.0 ],
									"style" : "",
									"text" : "ossia.gl_pix_brcosa.model pix_brcosa"
								}
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Downloads/stable/colour/gl_pix_brcosa",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
