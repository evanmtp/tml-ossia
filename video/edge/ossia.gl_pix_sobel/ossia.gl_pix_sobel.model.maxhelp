...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 15.0, 315.0, 33.0 ],
									"text" : "ossia.gl_pix_sobel.model"
								}
...
, 							{
								"box" : 								{
									...
									"lockeddragscroll" : 1,
									"maxclass" : "bpatcher",
									"name" : "ossia.gl_pix_sobel.view.maxpat",
									"numinlets" : 1,
									"numoutlets" : 1,
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 180.0, 135.0, 135.0, 75.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"text" : "ossia.gl_pix_sobel.model pix_sobel"
								}
