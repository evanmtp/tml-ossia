...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 240.0, 75.0, 19.0 ],
					"text" : "textures out"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 150.0, 62.0, 22.0 ],
					"text" : "weight $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 210.0, 90.0, 150.0, 45.0 ],
					"text" : "ossia.parameter weight @type float @range 0. 10. @description Line weight.",
					"varname" : "tolerance[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 150.0, 196.0, 26.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 210.0, 250.0, 33.0 ],
					"text" : "ossia.model #1 @description \"Robert's Cross edge detection implemented in jit.gl.pix.\"",
					"varname" : "jmod.hub"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 309.5, 185.0, 24.5, 185.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 95.5, 224.0, 24.5, 224.0 ],
					"source" : [ "obj-2", 1 ]
				}
