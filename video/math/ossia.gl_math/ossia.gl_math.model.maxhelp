...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"text" : "Load various math shaders."
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 225.0, 105.0, 150.0, 150.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 15.0, 285.0, 165.0, 22.0 ],
									"text" : "ossia.gl_math.model gl_math"
								}
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Github/tml-ossia/video/math/ossia.gl_math",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
