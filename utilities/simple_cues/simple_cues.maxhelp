...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 405.0, 180.0, 144.0, 64.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 450.0, 330.0, 142.0, 64.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 450.0, 270.0, 144.0, 91.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 240.0, 150.0, 150.0, 64.0 ],
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Github/PVH-maxlib_ossia/signal/ossia.pvh.complexosc~",
...
, 			{
				...
				"bootpath" : "~/Github/PVH-maxlib_ossia/signal/ossia.pvh.chanctl~",
...
, 			{
				...
				"bootpath" : "~/Github/PVH-maxlib_ossia/signal/ossia.pvh.complexosc~/include",
