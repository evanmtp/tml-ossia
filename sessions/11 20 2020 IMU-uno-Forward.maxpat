...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 585.0, 511.0, 38.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 510.0, 511.0, 38.0 ],
									"text" : "In Client mode.... sensor rate messages don't work: maybe it is a different osc namespace?"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 15.0, 225.0, 154.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 165.0, 195.0, 165.0, 22.0 ],
									"text" : "udpsend 192.168.0.100 7800"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 420.0, 511.0, 84.0 ],
									"text" : "different modules for: config? recieve? forward\n\nmaybe only the reciever is ossia and all else is bullet proof af\n\nmaybe having multiple forwardd modules just to to ddifferent udp sendds is not efficient"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 315.0, 334.0, 100.0 ],
									"text" : "Navid’s IP: 192.168.0.103\n\nBroken usb: 9000\nSolder battery: 9001\n\nNGIMU forward’s should not configure… but only receive"
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 15.0, 300.0, 120.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 15.0, 150.0, 208.0, 22.0 ],
