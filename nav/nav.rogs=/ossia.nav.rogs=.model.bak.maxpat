...
, 							{
								"box" : 								{
									...
									"text" : "ossia.parameter waveform/normalize @type decimal @range 0. 2. @clip both @description \"normalize the waveform to a desired loudness\""
								}
...
, 							{
								"box" : 								{
									...
									"text" : "ossia.parameter modAmt/gain @mode set @type decimal",
...
, 							{
								"box" : 								{
									...
									"text" : "ossia.parameter mod/gain @type decimal",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.0, 255.0, 304.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 464.0, 278.0, 236.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 349.0, 339.0, 459.0, 21.0 ],
					"text" : "ossia.parameter buffer/message @mode set @description \"full import message to buffer\"",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 669.0, 8.0, 61.0, 118.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 609.0, 8.0, 52.0, 130.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"text" : "ossia.parameter selection @type array @description \"selected region of audio\""
								}
...
, 							{
								"box" : 								{
									...
									"text" : "When j.nav.rogs is instantiated, ossia.parameter buffer/message @mode set spits out a “replace none” message. This goes to the buffer~, which can’t interpret it, resulting in a “buffer~: none: can't open” error being printed to the console. This is a little workaround to avoid that."
								}
...
, 							{
								"box" : 								{
									...
									"text" : "ossia.parameter file/ms @type decimal @description \"Duration of file in ms.\""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 120.0, 1170.0, 93.0, 96.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 150.0, 360.0, 146.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 300.0, 360.0, 105.0, 20.0 ],
									"text" : "ossia.remote file/ms"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 360.0, 1305.0, 193.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 360.0, 1335.0, 137.0, 45.0 ],
									"text" : "ossia.parameter modAmt/position @mode set @type decimal",
...
, 							{
								"box" : 								{
									...
									"text" : "ossia.parameter mod/position @type decimal",
									"varname" : "delayLength"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 285.0, 495.0, 108.0, 69.0 ],
									"text" : "ossia.parameter playback/position @type decimal @range 0. 1. @clip both"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 300.0, 90.0, 184.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 300.0, 120.0, 307.0, 21.0 ],
									"text" : "ossia.parameter modAmt/speed @mode set @type decimal",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 270.0, 60.0, 227.0, 21.0 ],
									"text" : "ossia.parameter mod/speed @type decimal",
									"varname" : "params/rate"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "ossia.parameter playback/speed @type decimal @range -10. 10. @clip free @priority 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 120.0, 1155.0, 105.0, 20.0 ],
									"text" : "ossia.remote file/ms"
								}
...
, 											{
												"box" : 												{
													...
													"text" : "ossia.parameter grain/duration @type decimal @range 1. 500. @clip low"
												}
...
, 											{
												"box" : 												{
													...
													"text" : "ossia.parameter modAmt/size @mode set @type decimal",
...
, 											{
												"box" : 												{
													...
													"text" : "ossia.parameter mod/size @type decimal",
...
, 											{
												"box" : 												{
													...
													"text" : "ossia.parameter pitch/variation @type decimal"
												}
...
, 											{
												"box" : 												{
													...
													"text" : "ossia.parameter modAmt/pitchVar @mode set @type decimal",
...
, 											{
												"box" : 												{
													...
													"text" : "ossia.parameter mod/pitchVar @type decimal",
...
, 											{
												"box" : 												{
													...
													"text" : "ossia.parameter pitch/transpose @type decimal @range -1200. 1200."
												}
...
, 											{
												"box" : 												{
													...
													"text" : "ossia.parameter modAmt/pitch @mode set @type decimal",
...
, 											{
												"box" : 												{
													...
													"text" : "ossia.parameter mod/pitch @type decimal",
...
, 											{
												"box" : 												{
													...
													"text" : "ossia.parameter grain/onsetVar @type decimal @range 0. 200. @clip low"
												}
...
, 											{
												"box" : 												{
													...
													"text" : "ossia.parameter modAmt/onsetVar @mode set @type decimal",
...
, 											{
												"box" : 												{
													...
													"text" : "ossia.parameter mod/onsetVar @type decimal",
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 101.999984999999995, 163.5, 209.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 101.999984999999995, 194.5, 295.0, 21.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 76.0, 132.0, 215.0, 21.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 50.0, 100.0, 304.0, 19.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 15.0, 15.0, 105.0, 41.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 96.0, 13.0, 185.0, 19.0 ],
...
, 											{
												"box" : 												{
													...
													"text" : "ossia.parameter modAmt/trigger @mode set @type decimal",
...
, 											{
												"box" : 												{
													...
													"text" : "ossia.parameter mod/trigger @type decimal",
...
, 											{
												"box" : 												{
													...
													"text" : "ossia.parameter grain/trigger/variance/rateVar/randomnessRate @range 0. 120. @type decimal @description \"rate of change of temporal variance in Hz\" @clip both",
...
, 											{
												"box" : 												{
													...
													"text" : "ossia.parameter grain/trigger/variance/rateVar/spread @range 0. 1000. @type decimal @description \"range or width or spread of temporal variance as % of the current tiggerRate(ms)\" @clip both",
...
, 											{
												"box" : 												{
													...
													"text" : "ossia.parameter grain/trigger/variance/gainVar/range @range 0. 500. @type decimalArray @description \"range or width or depth of loudness variance as a % where %100 mean up to *1. in linear gain\" @clip both",
...
, 											{
												"box" : 												{
													...
													"text" : "ossia.parameter grain/trigger/variance/gainVar/randomnessRate @range 0. 120. @type decimal @description \"range of change in loudness variance in Hz\" @clip both",
...
, 											{
												"box" : 												{
													...
													"text" : "ossia.parameter grain/trigger/freq @type decimal @range 0. 2000. @clip both @description \"grain rate\""
												}
...
, 			{
				...
				"bootpath" : "~/Documents/GitHub/cirk2_2/ossia.nav.oscroute",
				"patcherrelativepath" : "../ossia.nav.oscroute",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				...
				"patcherrelativepath" : "../ossia.namespacebrowser",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
