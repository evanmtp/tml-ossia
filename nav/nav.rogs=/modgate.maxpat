...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 60.0, 109.0, 22.0 ],
					"text" : "sprintf modAmt/%s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 15.0, 110.0, 22.0 ],
					"text" : "loadmess #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 60.0, 131.0, 22.0 ],
					"text" : "sprintf mapperGate/%s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 315.0, 91.0, 22.0 ],
					"text" : "speedlim 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 225.0, 135.0, 73.0, 21.0 ],
					"text" : "ossia.remote",
...
,
					"patching_rect" : [ 225.0, 210.0, 49.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 225.0, 180.0, 19.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 34.0, 0.0, 15.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.0, 210.0, 48.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 35.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 30.0, 255.0, 73.0, 21.0 ],
					"text" : "ossia.remote",
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 66.5, 300.0, 287.0, 300.0, 287.0, 204.0, 264.5, 204.0 ],
					"source" : [ "obj-15", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 99.5, 243.0, 39.5, 243.0 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-81", 0 ],
					"midpoints" : [ 230.5, 198.0, 210.0, 198.0, 210.0, 129.0, 234.5, 129.0 ],
					"order" : 1,
					"source" : [ "obj-74", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 99.5, 48.0, 234.5, 48.0 ],
					"order" : 0,
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 261.5, 174.0, 234.5, 174.0 ],
					"source" : [ "obj-81", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 234.5, 243.5, 39.5, 243.5 ],
					"source" : [ "obj-98", 0 ]
				}
