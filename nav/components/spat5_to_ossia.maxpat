...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 45.0, 15.0, 444.0, 20.0 ],
									"text" : "Navid's note: withput this seemingly extra step regexp was not prducing any utput!"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 15.0, 60.0, 1050.0, 22.0 ],
									"text" : "t b l"
								}
...
, 			{
				"box" : 				{
					"color" : [ 1.0, 0.427450980392157, 0.427450980392157, 1.0 ],
					"id" : "obj-12",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 15.0, 243.0, 33.0 ],
...
,
					"patching_rect" : [ 271.0, 96.0, 107.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 15.0, 320.0, 147.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "argument 1: name of the spat5 OSC node you want to save \nargument 1: the name for the Ossia parameter you will save into"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 435.0, 163.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 167.0, 300.0, 480.0, 127.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 141.833333333333314, 123.0, 54.5, 123.0 ],
					"source" : [ "obj-25", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-56", 0 ],
					"midpoints" : [ 83.166666666666657, 123.0, 54.5, 123.0 ],
					"source" : [ "obj-25", 1 ]
				}
