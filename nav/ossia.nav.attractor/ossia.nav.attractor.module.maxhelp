...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 17.0, 150.0, 36.0 ],
					"text" : "this module is an ossia wrapper for:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 255.0, 150.0, 51.0 ],
					"text" : "caution: xyz.dadras seems to explode no matter what"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 135.0, 300.0, 36.0 ],
					"text" : "it requires the XY Coordinates Generator Pack package from the Max Package Manager"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 90.0, 255.0, 19.0, 21.0 ],
					"text" : "z"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 255.0, 19.0, 21.0 ],
					"text" : "y"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 255.0, 19.0, 21.0 ],
					"text" : "x"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 315.0, 218.0, 218.0 ],
					"range" : [ 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 62.0, 322.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 90.0, 318.831042500000194, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "select from various 3d chaotic attractors"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 15.0, 194.0, 25.0 ],
					"text" : "ossia.nav.attractor"
				}
...
, 			{
				"box" : 				{
					...
					"lockedsize" : 0,
					"maxclass" : "bpatcher",
					"name" : "ossia.nav.attractor.module.maxpat",
					"numinlets" : 1,
					"numoutlets" : 4,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal", "signal", "" ],
					"patching_rect" : [ 15.0, 90.0, 105.0, 165.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 250.0, 59.0, 335.0, 60.0 ],
					"proportion" : 0.39,
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 1 ],
					"midpoints" : [ 53.166666666666671, 300.0, 223.5, 300.0 ],
					"source" : [ "obj-3", 1 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-3::obj-7::obj-17" : [ "live.text", "live.text", 0 ],
			"parameterbanks" : 			{
...
, 			{
				"name" : "ossia.nav.attractor.model.maxpat",
				"bootpath" : "~/Documents/GitHub/tml-ossia/nav/ossia.nav.attractor",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "ossia.nav.attractor.view.maxpat",
				"bootpath" : "~/Documents/GitHub/tml-ossia/nav/ossia.nav.attractor",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
...
, 			{
				"name" : "xyz.thomas.gendsp",
				"bootpath" : "~/Documents/Max 8/Packages/XY Coordinates Generator Pack/code",
				"patcherrelativepath" : "../../../../Max 8/Packages/XY Coordinates Generator Pack/code",
				"type" : "gDSP",
				"implicit" : 1
			}
 ],
