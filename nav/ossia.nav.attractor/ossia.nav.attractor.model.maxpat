...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 585.0, 195.0, 105.0, 96.0 ],
					"text" : "ossia.parameter attractor @type int @range 0 6 @clip both @default 0",
					"varname" : "rate/min[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 585.0, 360.0, 76.0, 22.0 ],
					"text" : "prepend gen"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 195.0, 122.0, 81.0 ],
					"text" : "ossia.parameter speed @type float @range 0. 20000. @clip low @default 50",
					"varname" : "rate/min[7]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 450.0, 195.0, 121.0, 52.0 ],
					"text" : "ossia.parameter z @type float @default 0.1",
					"varname" : "rate/min[6]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 315.0, 195.0, 121.0, 52.0 ],
					"text" : "ossia.parameter y @type float @default 0.1",
					"varname" : "rate/min[4]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 180.0, 195.0, 121.0, 52.0 ],
					"text" : "ossia.parameter x @type float @default 0.1",
					"varname" : "rate/min[5]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.0, 255.0, 62.0, 22.0 ],
					"text" : "prepend z"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 255.0, 62.0, 22.0 ],
					"text" : "prepend y"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.0, 255.0, 62.0, 22.0 ],
					"text" : "prepend x"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 15.0, 397.0, 30.0 ],
					"text" : "Strange Attractors - XY",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 46.0, 485.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 405.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 480.0, 33.0, 33.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 450.0, 127.0, 22.0 ],
					"text" : "ossia.model #1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 75.0, 240.0, 50.0 ],
					"text" : "adapted to ossia by\nEvan Montpellier and Navid Navab\n2022"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 12.0, 576.168957499999806, 61.0 ],
					"proportion" : 0.39,
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 594.5, 393.0, 24.5, 393.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 354.5, 475.0, 354.5, 475.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 635.0, 348.0, 594.5, 348.0 ],
					"source" : [ "obj-3", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 82.5, 438.0, 69.5, 438.0 ],
					"source" : [ "obj-32", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 140.5, 438.0, 114.5, 438.0 ],
					"source" : [ "obj-32", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 324.5, 288.0, 24.5, 288.0 ],
					"source" : [ "obj-34", 0 ]
				}
