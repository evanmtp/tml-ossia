...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 105.0, 480.0, 22.0 ],
					"text" : "you've got what i want, you've got what i need, shake it up",
...
, 			{
				"box" : 				{
					...
					"text" : "mubu-based shaker instrument"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 15.0, 630.0, 64.0 ],
					"text" : "ossia.nav.mubu.shaker.model"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 285.0, 195.0, 150.0, 37.0 ],
					"text" : "click to record into mubu container"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 285.0, 150.0, 150.0, 24.0 ],
					"text" : "click for imubu UI"
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.435294117647059, 0.458823529411765, 0.741176470588235, 1.0 ],
					"format" : 6,
					"id" : "obj-7",
					"maxclass" : "flonum",
					"numinlets" : 1,
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Desktop/nav.mubu.shaker___good",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				...
				"patcherrelativepath" : "../../Github/tml-ossia/nav/nav.oscroute",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"patcherrelativepath" : "../../Github/tml-ossia/utilities/namespacebrowser",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
